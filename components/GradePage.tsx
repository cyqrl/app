...
const SubjectScreen: React.FC<SubjectScreenProps> = ({ initialSubjectName, drawers,grade }) => {
  ...
  const renderPage = () => {
    ...
    return (
      <PdfViewer grade={grade} subjectKey={currentPage} subjectName={selectedSubjectName} />
    );
  };

  const nextItem = (drawer: any, setter: any, list: any, direction: any) => {
